  ...
  return (
    <div className="max-w-lg mx-auto p-6 pb-24">
      <header className="flex justify-between items-center mb-6">
        ...
        <h1 className="text-xl font-bold text-[var(--color-text-primary)]">Learn GZCLP</h1>
        <div className="w-14" />
      </header>

      <div className="space-y-8">
        <section>
          <h2 className="text-lg font-semibold text-[var(--color-text-primary)] mb-2">The Philosophy</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--color-text-primary)] mb-2">Why the Failure Scheme Matters</h2>
          <p className="text-[var(--color-text-secondary)] text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--color-text-primary)] mb-2">The Sawtooth Pattern</h2>
          <p className="text-[var(--color-text-secondary)] text-sm leading-relaxed mb-4">
            ...
            <div className="bg-[var(--color-bg-surface)]/50 rounded-xl p-6 text-center">
            <pre className="text-[var(--color-text-secondary)] text-xs font-mono whitespace-pre">
{`    /\\
   /  \\
  /    \\___
 /         \\
/           \\___`}
            ...
            <p className="text-[var(--color-text-muted)] text-xs mt-2">Climb → Fail → Reset → Climb higher</p>
          </div>
        </section>
      </div>
    </div>
